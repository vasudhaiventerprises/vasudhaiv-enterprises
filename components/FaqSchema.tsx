export default function FaqSchema() {
  const faqData = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "What is the cost of solar panel installation in Uttar Pradesh?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Is solar subsidy available in Uttar Pradesh?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Most rooftop solar installations in Uttar Pradesh are completed within 1–3 days after approvals.",
        },
      },
      {
        "@type": "Question",
