...
export const metadata = {
  title: "Solar Panel Installation in Uttar Pradesh | Rooftop Solar Experts",
  description: "Get affordable solar panel installation in Uttar Pradesh with government subsidy support. Residential and commercial rooftop solar solutions by Vasudhaiv Enterprises.",
};
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-6 py-32 prose prose-invert prose-emerald">
        <h1 className="text-3xl font-bold">Solar Panel Installation in Uttar Pradesh</h1>
        <p className="mt-4">Vasudhaiv Enterprises provides complete solar panel installation in Uttar Pradesh for homes, shops, schools, hospitals, and factories. Our rooftop solar systems help reduce electricity bills by up to 90% while increasing long-term property value and energy independence.</p>
        
        <h2 className="mt-6 text-xl font-semibold">Why Install Solar Panels in Uttar Pradesh?</h2>
        <p>Uttar Pradesh receives strong sunlight throughout the year, making rooftop solar installation one of the smartest investments for residential and commercial buildings. With rising electricity costs, solar energy offers a reliable and affordable long-term solution.</p>
        ...
        <h2 className="mt-6 text-xl font-semibold">Solar System Cost in Uttar Pradesh</h2>
        ...
        <p>Contact Vasudhaiv Enterprises today for expert rooftop solar panel installation in Uttar Pradesh. Our team will design the best solar solution based on your electricity usage and roof size.</p>
      </div>
      <FooterSection />
    </main>
    </>
